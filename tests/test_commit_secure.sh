...
output=$(bash ./sitm/secure/commit-secure.sh 2>&1)
exit_code=$?
...
output=$(bash ./sitm/secure/commit-secure.sh -cred -m "test" 2>&1)
exit_code=$?
...
output=$(bash ./sitm/secure/commit-secure.sh -cred -m "test commit" 2>&1)
exit_code=$?
