...
from sitm_core.cache.cred_cache import save_cache
...
def main():
    ...
    parser.add_argument("--no-cache", action="store_true", help="Force full credential scan (bypass smart scan)")
    parser.add_argument("--reset-cache", action="store_true", help="Clear cache before scanning (only used with smart scan)")
